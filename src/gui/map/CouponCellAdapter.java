 ...
 */
public class CouponCellAdapter extends CellMapAdapter {
    private MapViewer viewer;
    private static ImageIcon icon;
    public CouponCellAdapter(AbstractCell cell, MapViewer viewer) {
        super(cell, viewer);
        this.viewer = viewer;
        if (icon == null){
            icon = new ImageIcon(getClass().getResource("/image/coupon.png"));
        }
    }
